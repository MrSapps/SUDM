...
#undef posString
    ...
    uint16 numInsts = static_cast<uint16>(_dataChunk._size / 2);
    for (uint16 i = 0; i < numInsts; ++i)
    {
        ...
        case 0:
            ...
            if (parameter < minFuncAddr)
                jumpTargets.insert(static_cast<uint16>(_insts.size()));
            ADD_OPCODE<Kyra2UncondJumpInstruction>(opcode, address, parameter, "jumpTo", 0, true, false, true);
            break;
        case 1:
            ADD_OPCODE<Kyra2StoreInstruction>(opcode, address, parameter, "setRetValue", 0, true, true, false);
            break;
        case 2:
            if (parameter == 0)
            {
                ADD_OPCODE<Kyra2LoadInstruction>(opcode, address, parameter, "pushRet", 1, false, false, false);
            }
            else if (parameter == 1) {
                ADD_OPCODE<Kyra2NoOutputInstruction>(opcode, address, parameter, "pushPos", 0, false, false, false); // Sets up function call
            }
            else 
            {
        ...
        case 3:
        case 4:
            ADD_OPCODE<Kyra2LoadInstruction>(opcode, address, parameter, "push", 1, true, true, false);
            break;
        case 5:
            ADD_OPCODE<Kyra2LoadInstruction>(opcode, address, parameter, "pushVar", 1, true, true, false);
            break;
        case 6:
            ADD_OPCODE<Kyra2LoadInstruction>(opcode, address, parameter, "pushBPNeg", 1, true, true, false);
            break;
        case 7:
            ADD_OPCODE<Kyra2LoadInstruction>(opcode, address, parameter, "pushBPAdd", 1, true, true, false);
            break;
        case 8:
            if (parameter == 0)
            {
                ADD_OPCODE<Kyra2StoreInstruction>(opcode, address, parameter, "popRet", -1, false, false, false);
            }
            else if (parameter == 1) 
            {
                ADD_OPCODE<ReturnInstruction>(opcode, address, parameter, "popPos", 0, false, false, false); // Returns from function call
            }
            else
            {
                // Error: invalid parameter halts execution
            ...
            break;
        case 9:
            ADD_OPCODE<Kyra2StoreInstruction>(opcode, address, parameter, "popVar", -1, true, true, false);
            break;
        case 10:
            ADD_OPCODE<Kyra2StoreInstruction>(opcode, address, parameter, "popBPNeg", -1, true, true, false);
            break;
        case 11:
            ADD_OPCODE<Kyra2StoreInstruction>(opcode, address, parameter, "popBPAdd", -1, true, true, false);
            break;
        case 12:
            ADD_OPCODE<Kyra2StackInstruction>(opcode, address, parameter, "addSP", -parameter, true, true, false);
            break;
        case 13:
            ADD_OPCODE<Kyra2StackInstruction>(opcode, address, parameter, "subSP", parameter, true, true, false);
            break;
        case 14:
            ...
            ADD_OPCODE<Kyra2KernelCallInstruction>(opcode, address, parameter, _funcs[parameter]._name, 0, false, false, false, _funcs[parameter]._metadata);
            break;
        case 15:
            parameter *= 2;
            if (parameter < minFuncAddr)
                jumpTargets.insert(static_cast<uint16>(_insts.size()));
            ADD_OPCODE<Kyra2CondJumpInstruction>(opcode, address, parameter, "ifNotJmp", -1, true, false, true);
            break;
        case 16:
            if (parameter == 0) 
            {
                ADD_OPCODE<BoolNegateStackInstruction>(opcode, address, parameter, "boolNegate", 0, false, false, false);
            }
            else if (parameter == 1)
            {
                ADD_OPCODE<UnaryOpPrefixStackInstruction>(opcode, address, parameter, "arithmeticNegate", 0, false, false, false, "-");
            }
            else if (parameter == 2) 
            {
                ADD_OPCODE<UnaryOpPrefixStackInstruction>(opcode, address, parameter, "bitwiseNegate", 0, false, false, false, "~");
            }
            else 
            {
                // Error: invalid parameter halts execution
        ...
        case 17:
            ...
            {
            case 0:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_band", -1, false, false, false, "&&");
                break;
            case 1:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_bor", -1, false, false, false, "||");
                break;
            case 2:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_eq", -1, false, false, false, "==");
                break;
            case 3:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_neq", -1, false, false, false, "!=");
                break;
            case 4:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_leq", -1, false, false, false, "<=");
                break;
            case 5:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_lt", -1, false, false, false, "<");
                break;
            case 6:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_geq", -1, false, false, false, ">=");
                break;
            case 7:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_gt", -1, false, false, false, ">");
                break;
            case 8:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_add", -1, false, false, false, "+");
                break;
            case 9:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_sub", -1, false, false, false, "-");
                break;
            case 10:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_mult", -1, false, false, false, "*");
                break;
            case 11:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_div", -1, false, false, false, "/");
                break;
            case 12:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_shr", -1, false, false, false, ">>");
                break;
            case 13:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_shl", -1, false, false, false, "<<");
                break;
            case 14:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_land", -1, false, false, false, "&");
                break;
            case 15:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_lor", -1, false, false, false, "|");
                break;
            case 16:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_mod", -1, false, false, false, "%");
                break;
            case 17:
                ADD_OPCODE<BinaryOpStackInstruction>(opcode, address, parameter, "eval_xor", -1, false, false, false, "^");
                break;
            default:
                // Error: invalid parameter halts execution
                throw UnknownOpcodeException(address, opcode);
        ...
        case 18:
            ...
            ADD_OPCODE<Kyra2NoOutputInstruction>(opcode, address, parameter, "setRetAndJmp", -2, false, false, false);
            break;
        default:
    ...
    for (InstIterator it = _insts.begin(); it != _insts.end(); ++it)
        addrMap[static_cast<uint16>((*it)->_address)] = it;
